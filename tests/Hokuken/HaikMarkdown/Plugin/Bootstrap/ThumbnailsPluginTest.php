<?php
use Hokuken\HaikMarkdown\Plugin\Bootstrap\Thumbnails\ThumbnailsPlugin;
...
class ThumbnailsPluginTest extends PHPUnit_Framework_TestCase {
    ...
    {
        $this->assertInstanceOf('\Hokuken\HaikMarkdown\Plugin\Bootstrap\Cols\ColsPlugin', $this->plugin);
    }
