<?php
use Hokuken\HaikMarkdown\Plugin\Bootstrap\Section\SectionPlugin;
...
class SectionPluginTest extends PHPUnit_Framework_TestCase {
    ...
    public function testCalledPlugin()
    {
        ...
        if (Hokuken\HaikMarkdown\Plugin\PluginCounter::getInstance()->get('Hokuken\HaikMarkdown\Plugin\Bootstrap\Section\SectionPlugin') === 0)
        {
    ...
    {
        $body = "test1\n" . "\n\n++++\n\n" . "test2\n";
        $this->plugin = new SectionPlugin(new Hokuken\HaikMarkdown\HaikMarkdown);
        $expected = array(
            'tag' => 'div',
            'attributes' => array(
                'class' => 'haik-plugin-section'
