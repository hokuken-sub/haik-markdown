<?php
use Hokuken\HaikMarkdown\Plugin\FlatUI\Icon\IconPlugin;

class FlatUIIconPluginTest extends PHPUnit_Framework_TestCase {
        ...
        return array(
            'default' => array(
                ...
                'expected' => array(
                    'tag' => 'i',
                    'attributes' => array(
                        'class' => 'haik-plugin-icon fui-search',
                        'content' => ''
                    ),
                )
            ),
            'specified_multi_icon_takes_first' => array(
                'icon' => array('plus', 'check'),
                'expected' => array(
                    'tag' => 'i',
                    'attributes' => array(
                        'class' => 'haik-plugin-icon fui-plus',
                        'content' => ''
                    ),
                )
            ),
            'contains_head_spaces' => array(
                ...
                'expected' => array(
                    'tag' => 'i',
                    'attributes' => array(
                        'class' => 'haik-plugin-icon fui-list',
                        'content' => ''
                    ),
                )
            ),
            ...
            'contains_glyphicon_first' => array(
    ...
    public function testIgnoreInvalidIconName($invalid_icon_name)
    {
        ...
        $expected = array(
            'tag' => 'i',
            'attributes' => array(
                'class' => 'haik-plugin-icon fui-star'
            ),
        );
        $this->assertTag($expected, $result);
    }
